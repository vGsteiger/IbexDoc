...
pub async fn list_available_models(
    ...
    let available_models = vec![
        ...
        AvailableModel {
            name: "MedGemma 1.5 4B IT Q4_K_M".to_string(),
            filename: "medgemma-1.5-4b-it-Q4_K_M.gguf".to_string(),
            size_bytes: 2_489_894_976,
            min_ram_gb: 8,
            description: "Medical-domain 4B instruction-tuned model for on-device drafting.".to_string(),
            disclaimer: Some("Use for clinician-reviewed drafting only. This model is not validated for diagnosis or treatment decisions.".to_string()),
            is_downloaded: false,
            model_id: None,
        },
    ];
